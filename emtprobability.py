...
if __name__ == "__main__":
    ...
    #plt.figure()
    p21=ax1.plot(t01,zs1,color='r', linestyle='--', marker='*')
    p22=ax1.plot(t02,zs2,color='r', linestyle='dashdot', marker='v')
    #p23=ax1.plot(t11,ls11,color='r', linestyle='dotted', marker='^')
    p23=ax1.plot(t11,ls11,color='y', marker='^')
    p31=ax1.plot(t12,ls12,color='y',marker='o')
    p32=ax1.plot(t21,ls21,color='b',marker='^')
    p33=ax1.plot(t22,ls22,color='b',marker='o')
